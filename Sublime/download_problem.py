...
{Colors.HEADER}Usage examples:{Colors.END}
   {Colors.OKBLUE}• Download 1 problem:     {Colors.END}python3 download_problem.py
   {Colors.OKBLUE}• Download 3 problems:    {Colors.END}python3 download_problem.py -n 3
   {Colors.OKBLUE}• Download 2 batches:     {Colors.END}python3 download_problem.py -b 2
   {Colors.OKBLUE}• Dry run (preview only): {Colors.END}python3 download_problem.py --dryrun
